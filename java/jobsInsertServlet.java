...
public class jobsInsertServlet extends HttpServlet{
	...
	public int executeJobs(String input1, String input2, int input3, String input4) {
	...
	protected void doPost(HttpServletRequest request,
		...
		String input1 = request.getParameter("jnum");
		String input2 = request.getParameter("jname");
		int input3 = Integer.parseInt(request.getParameter("numworkers"));
		String input4 = request.getParameter("city");
		System.out.println("inputs: " + input1 + " " + input2 + " " + input3 + " " + input4);
		
		//insertion
		int rows = executeJobs( input1,  input2,  input3,  input4);
		
		//for re-routing to dataentry page.
		request.setAttribute("commandType", "jobs");
		request.setAttribute("rowsCount", rows);
		
		request.setAttribute("jnum", input1);
		request.setAttribute("jname", input2);
		request.setAttribute("numworkers", input3);
